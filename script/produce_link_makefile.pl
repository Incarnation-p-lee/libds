...
my $obj_list = "";
my $obj_part = "";
my $obj_dir = shift @ARGV;
my $bin_dir = shift @ARGV;

say "Produce link Makefile";

die "Failed to find $obj_dir director." unless -d -e $obj_dir;

###############################################
## Collecting all objective files in obj_dir ##
###############################################
opendir OUTPUT, $obj_dir or
    die "Failed to open output directory $obj_dir, $?\n";
...
######################################
open MAKEFILE, '>', "$obj_dir/Makefile" or
