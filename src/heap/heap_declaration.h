...
static inline struct doubly_linked_list * maximal_heap_remove_internal(struct maximal_heap *heap, uint32 index);
static inline struct doubly_linked_list * minimal_heap_remove_internal(struct minimal_heap *heap, uint32 index);
...
struct maximal_heap * maximal_heap_build(struct heap_data **chain_array, uint32 size);
struct maximal_heap * maximal_heap_create(uint32 capacity);
struct min_max_heap * min_max_heap_create(uint32 capacity);
struct minimal_heap * minimal_heap_build(struct heap_data **chain_array, uint32 size);
