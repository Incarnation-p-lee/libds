...
static inline bool binary_heap_down_ordered_p(void *func_ptr);
...
static inline void minimal_heap_node_nice_alter_internal(struct binary_heap *heap, uint32 index, sint64 new_nice);
