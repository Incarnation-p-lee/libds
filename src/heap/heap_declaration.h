...
static inline bool binary_heap_nice_repeated_p(struct binary_heap *heap, uint32 index, sint64 nice);
...
static inline struct doubly_linked_list * leftist_heap_node_find_min_internal(struct leftist_heap *heap);
...
static inline void binary_heap_node_collision_merge(struct binary_heap *heap, uint32 t_index, uint32 s_index);
...
struct doubly_linked_list * leftist_heap_node_find_min(struct leftist_heap *heap);
...
void leftist_heap_node_insert(struct leftist_heap *heap, void *val, sint64 nice);
