...
static inline bool binary_heap_structure_illegal_p(struct binary_heap *heap);
...
static inline uint32 binary_heap_find_index(struct binary_heap *heap, void *val);
...
static inline uint32 binary_heap_index_limit(struct binary_heap *heap);
