...
static inline bool leftist_heap_node_heap_ordered_p(s_leftist_heap_t *node);
static inline bool leftist_heap_node_heap_unordered_p(s_leftist_heap_t *node);
static inline bool leftist_heap_npl_optimize_validity_p(s_leftist_heap_t *node, sint32 expected);
static inline bool leftist_heap_validity_p(s_leftist_heap_t *heap);
static inline bool min_max_heap_ordered_p(s_min_max_heap_t *heap);
static inline sint32 leftist_heap_npl_default_i(s_leftist_heap_t *node);
...
bool maximal_heap_ordered_p(s_maximal_heap_t *heap);
...
bool minimal_heap_ordered_p(s_minimal_heap_t *heap);
...
static inline bool binary_heap_min_max_down_unordered_p(s_binary_heap_t *heap, uint32 index, sint64 nice, uint32 *tgt_index);
static inline bool binary_heap_min_max_up_ordered_p(s_binary_heap_t *heap, uint32 index, sint64 nice, uint32 *tgt_index);
static inline bool binary_heap_min_max_up_unordered_p(s_binary_heap_t *heap, uint32 index, sint64 nice, uint32 *tgt_index);
...
static inline bool maximal_heap_ordered_ip(s_maximal_heap_t *heap);
...
static inline bool minimal_heap_ordered_ip(s_minimal_heap_t *heap);
