...
s_open_addressing_hash_t * open_addressing_hash_rehashing(s_open_addressing_hash_t **hash);
...
static inline void open_addressing_hash_space_rehashing(s_open_addressing_hash_t *to, s_open_addressing_hash_t *from);
...
uint32 open_addressing_hash_load_factor_calculate(s_open_addressing_hash_t *hash);
