...
static inline bool array_queue_resize_expand_data_consistant_p(s_array_queue_t *queue);
static inline bool array_queue_resize_expand_restore_data_p(s_array_queue_t *queue, uint32 size, void **addr);
...
uint32 array_queue_size(s_array_queue_t *queue);
