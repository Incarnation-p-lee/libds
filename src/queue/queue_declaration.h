...
void * doubly_end_queue_head(s_doubly_end_queue_t *queue);
void * doubly_end_queue_head_leave(s_doubly_end_queue_t *queue);
void * doubly_end_queue_tail(s_doubly_end_queue_t *queue);
void * doubly_end_queue_tail_leave(s_doubly_end_queue_t *queue);
...
void doubly_end_queue_head_enter(s_doubly_end_queue_t *queue, void *member);
void doubly_end_queue_iterate(s_doubly_end_queue_t *queue, void (*handle)(void *));
void doubly_end_queue_tail_enter(s_doubly_end_queue_t *queue, void *member);
