...
s_array_queue_t * array_stack_copy_to_queue(s_array_stack_t *stack);
...
static inline bool array_stack_structure_illegal_ip(s_array_stack_t *stack);
...
static inline s_array_queue_t * array_stack_copy_to_queue_i(s_array_stack_t *stack);
