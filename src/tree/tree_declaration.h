...
static inline bool avl_tree_balanced_default_p(struct avl_tree *node);
...
static inline bool binary_search_tree_balanced_p(struct binary_search_tree *tree);
...
static inline bool binary_search_tree_node_balanced_p(struct binary_search_tree *node);
...
static inline struct binary_search_tree * avl_tree_remove_internal(struct binary_search_tree **tree, sint64 nice);
...
static inline void avl_tree_remove_rotate_right(struct binary_search_tree **tree, struct binary_search_tree *node);
...
static inline void binary_search_tree_child_doubly_strip(struct binary_search_tree **pre, struct binary_search_tree *node);
...
static inline void binary_search_tree_node_swap(struct binary_search_tree *a, struct binary_search_tree *b);
...
void * avl_tree_remove(struct avl_tree **tree, struct avl_tree *node);
