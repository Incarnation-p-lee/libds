...
static inline bool binary_search_tree_leaf_p(struct binary_search_tree *node);
...
static inline struct binary_search_tree * binary_search_tree_child_doubly_strip(struct binary_search_tree **pre, struct binary_search_tree *node);
...
static inline struct binary_search_tree * binary_search_tree_left_find_max(struct binary_search_tree *tree);
static inline struct binary_search_tree * binary_search_tree_right_find_min(struct binary_search_tree *tree);
...
static inline void * binary_search_tree_child_lt_doubly_strip(struct binary_search_tree **pre, struct binary_search_tree *node);
static inline void * binary_search_tree_remove_internal(struct binary_search_tree **tree, struct binary_search_tree *node);
...
static inline void binary_search_tree_child_clean(struct binary_search_tree *node);
static inline void binary_search_tree_data_copy(struct nv_data *tgt, struct nv_data *node);
static inline void binary_search_tree_data_swap(struct nv_data *m, struct nv_data *n);
static inline void binary_search_tree_destroy_internal(struct binary_search_tree **tree);
static inline void binary_search_tree_initial_internal(struct binary_search_tree *tree, sint64 nice, void *val);
...
void * binary_search_tree_remove(struct binary_search_tree **tree, struct binary_search_tree *node);
...
void binary_search_tree_initial(struct binary_search_tree *tree, sint64 nice, void *val);
