...
static inline bool avl_tree_structure_illegal_p(s_avl_tree_t *tree);
...
static inline s_avl_tree_t ** avl_tree_node_doubly_child_left_swap_to_left(s_avl_tree_t **node, s_array_stack_t *path_stack);
static inline s_avl_tree_t ** avl_tree_node_doubly_child_right_swap_to_left(s_avl_tree_t **node, s_array_stack_t *path_stack);
...
static inline void avl_tree_balance_rotate(s_array_stack_t *path_stack);
static inline void avl_tree_balance_rotate_i(s_avl_tree_t **tree, uint32 path_type);
