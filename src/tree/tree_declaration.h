...
bool avl_tree_structure_illegal_p(s_avl_tree_t *tree);
bool avl_tree_structure_legal_p(s_avl_tree_t *tree);
bool binary_search_tree_contains_p(s_binary_search_tree_t *tree, s_binary_search_tree_t *node);
bool binary_search_tree_structure_illegal_p(s_binary_search_tree_t *tree);
bool binary_search_tree_structure_legal_p(s_binary_search_tree_t *tree);
bool splay_tree_contains_p(s_splay_tree_t *tree, s_splay_tree_t *node);
bool splay_tree_structure_illegal_p(s_splay_tree_t *tree);
bool splay_tree_structure_legal_p(s_splay_tree_t *tree);
...
s_avl_tree_t * avl_tree_create(void *val, sint64 nice);
...
s_binary_search_tree_t * binary_search_tree_create(void *val, sint64 nice);
...
s_doubly_linked_list_t * avl_tree_val_list(s_avl_tree_t *tree);
s_doubly_linked_list_t * binary_search_tree_val_list(s_binary_search_tree_t *tree);
s_doubly_linked_list_t * splay_tree_val_list(s_splay_tree_t *tree);
s_splay_tree_t * splay_tree_create(void *val, sint64 nice);
...
static inline bool binary_search_tree_contains_ip(s_binary_search_tree_t *tree, s_binary_search_tree_t *node);
static inline bool binary_search_tree_doubly_child_p(s_binary_search_tree_t *node);
static inline bool binary_search_tree_structure_illegal_ip(s_binary_search_tree_t *tree);
static inline bool binary_search_tree_structure_legal_ip(s_binary_search_tree_t *tree);
...
static inline bool splay_tree_structure_illegal_ip(s_splay_tree_t *tree);
static inline bool splay_tree_structure_legal_ip(s_splay_tree_t *tree);
...
static inline s_avl_tree_t * avl_tree_insert_i(s_avl_tree_t **tree, s_avl_tree_t *inserted);
...
static inline s_avl_tree_t ** avl_tree_node_doubly_child_left_swap_to_leaf(s_avl_tree_t **node, s_array_stack_t *path_stack);
static inline s_avl_tree_t ** avl_tree_node_doubly_child_right_swap_to_leaf(s_avl_tree_t **node, s_array_stack_t *path_stack);
static inline s_avl_tree_t ** avl_tree_node_doubly_child_swap_to_leaf(s_avl_tree_t **node, s_array_stack_t *path_stack);
static inline s_avl_tree_t ** avl_tree_node_sinlge_child_left_swap_to_leaf(s_avl_tree_t **node, s_array_stack_t *path_stack);
static inline s_avl_tree_t ** avl_tree_node_sinlge_child_right_swap_to_leaf(s_avl_tree_t **node, s_array_stack_t *path_stack);
...
static inline s_binary_search_tree_t * binary_search_tree_insert_i(s_binary_search_tree_t *tree, s_binary_search_tree_t *inserted);
static inline s_binary_search_tree_t * binary_search_tree_left_i(s_binary_search_tree_t *tree);
static inline s_binary_search_tree_t * binary_search_tree_remove_i(s_binary_search_tree_t **tree, s_binary_search_tree_t *node);
static inline s_binary_search_tree_t * binary_search_tree_right_i(s_binary_search_tree_t *tree);
...
static inline s_doubly_linked_list_t * avl_tree_val_list_i(s_avl_tree_t *tree);
static inline s_doubly_linked_list_t * binary_search_tree_val_list_i(s_binary_search_tree_t *tree);
static inline s_doubly_linked_list_t * splay_tree_val_list_i(s_splay_tree_t *tree);
...
static inline sint32 ALWAYS_INLINE avl_tree_height_opt(struct avl_tree *tree)  /* Fix-Me */;
...
static inline sint64 binary_search_tree_nice_i(s_binary_search_tree_t *tree);
static inline void avl_tree_balance_rotate_left_to_left(s_avl_tree_t **tree);
static inline void avl_tree_balance_rotate_left_to_right(s_avl_tree_t **tree);
static inline void avl_tree_balance_rotate_right_to_left(s_avl_tree_t **tree);
static inline void avl_tree_balance_rotate_right_to_right(s_avl_tree_t **tree);
static inline void avl_tree_destroy_i(s_avl_tree_t *tree);
static inline void avl_tree_height_update(s_avl_tree_t *tree);
static inline void avl_tree_initial_i(s_avl_tree_t *tree, void *val, sint64 nice);
static inline void avl_tree_insert_rotate(s_array_stack_t *path_stack);
static inline void avl_tree_insert_rotate_i(s_avl_tree_t **tree, uint32 path_type);
static inline void avl_tree_iterate_i(s_avl_tree_t *tree, void (*handler)(void *));
static inline void avl_tree_node_children_swap(s_avl_tree_t *a, s_avl_tree_t *b);
static inline void avl_tree_node_leaf_strip(s_avl_tree_t **node, s_array_stack_t *path_stack);
static inline void avl_tree_node_left_swap_path_update(s_avl_tree_t **node, s_array_stack_t *path_stack);
static inline void avl_tree_node_merge(s_avl_tree_t *merged, s_avl_tree_t *node);
static inline void avl_tree_node_right_swap_path_update(s_avl_tree_t **node, s_array_stack_t *path_stack);
static inline void avl_tree_node_strip(s_avl_tree_t **node, s_array_stack_t *path_stack);
static inline void avl_tree_remove_rotate(s_array_stack_t *path_stack);
static inline void avl_tree_remove_rotate_i(s_avl_tree_t **tree);
static inline void binary_indexed_tree_add_i(s_binary_indexed_tree_t *tree, uint32 number, sint64 val);
static inline void binary_search_tree_child_left_strip(s_binary_search_tree_t **binary_node);
static inline void binary_search_tree_child_right_strip(s_binary_search_tree_t **binary_node);
...
static inline void binary_search_tree_initial_i(s_binary_search_tree_t *tree, void *val, sint64 nice);
static inline void binary_search_tree_iterate_i(s_binary_search_tree_t *tree, void (*handler)(void *));
static inline void binary_search_tree_lt_doubly_child_strip(s_binary_search_tree_t **node);
static inline void binary_search_tree_node_merge(s_binary_search_tree_t *merged, s_binary_search_tree_t *node);
...
static inline void splay_tree_doubly_child_left_strip(s_splay_tree_t **splay_node);
static inline void splay_tree_doubly_child_right_strip(s_splay_tree_t **splay_node);
static inline void splay_tree_doubly_child_strip(s_splay_tree_t **splay_node, sint32 direction);
static inline void splay_tree_initial_i(s_splay_tree_t *tree, void *val, sint64 nice);
...
static inline void splay_tree_node_merge(s_splay_tree_t *merged, s_splay_tree_t *node);
static inline void splay_tree_splaying(s_array_stack_t *path_stack);
static inline void splay_tree_splaying_i(s_splay_tree_t **tree, uint32 path_mask);
static inline void splay_tree_splaying_left_to_left(s_splay_tree_t **tree);
static inline void splay_tree_splaying_left_to_right(s_splay_tree_t **tree);
static inline void splay_tree_splaying_right_to_left(s_splay_tree_t **tree);
static inline void splay_tree_splaying_right_to_right(s_splay_tree_t **tree);
static inline void splay_tree_splaying_root(s_splay_tree_t **tree, uint32 path_mask);
static inline void splay_tree_splaying_root_left(s_splay_tree_t **tree);
static inline void splay_tree_splaying_root_right(s_splay_tree_t **tree);
...
void avl_tree_initial(s_avl_tree_t *tree, void *val, sint64 nice);
...
void binary_search_tree_initial(s_binary_search_tree_t *tree, void *val, sint64 nice);
...
void splay_tree_initial(s_splay_tree_t *tree, void *val, sint64 nice);
