...
static __attribute__((noinline)) bool avl_tree_node_balanced_p(s_avl_tree_t *node);
static __attribute__((noinline)) s_avl_tree_t * avl_tree_insert_i(s_avl_tree_t **tree, s_avl_tree_t *node);
static __attribute__((noinline)) void avl_tree_rotate_left(s_avl_tree_t **tree);
static __attribute__((noinline)) void avl_tree_rotate_right(s_avl_tree_t **tree);
