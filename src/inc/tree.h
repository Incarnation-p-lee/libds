...
static inline struct avl_tree * avl_tree_node_child_left(struct avl_tree *node);
static inline void avl_tree_node_child_left_set(struct avl_tree *node, void *val);
static inline struct avl_tree * avl_tree_node_child_right(struct avl_tree *node);
static inline void avl_tree_node_child_right_set(struct avl_tree *node, void *val);
