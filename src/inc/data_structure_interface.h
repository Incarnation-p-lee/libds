...
extern bool semaphore_unavailable_p(s_semaphore_t *semaphore);
...
extern void mutex_destroy(s_mutex_t **mutex);
extern void mutex_lock(s_mutex_t *mutex);
extern void mutex_unlock(s_mutex_t *mutex);
