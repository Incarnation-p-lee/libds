...
extern void avl_tree_iterate(s_avl_tree_t *tree, void (*handle)(void *), enum ITER_ORDER order);
...
extern void binary_search_tree_iterate(s_binary_search_tree_t *tree, void (*handle)(void *), e_iter_order_t order);
