...
static inline s_doubly_linked_list_t * test_doubly_linked_list_sample(uint32 range, uint32 node_count);
static inline s_single_linked_list_t * test_single_linked_list_sample(uint32 range, uint32 node_count);
static inline s_skip_linked_list_t * test_skip_linked_list_sample(uint32 range, uint32 count);
