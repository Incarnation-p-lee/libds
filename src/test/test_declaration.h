...
static inline s_avl_tree_t * test_avl_tree_sample(uint64 range, uint32 count);
...
static inline s_graph_t * test_directed_graph_connected_sample(uint64 range, uint32 size);
...
static inline s_leftist_heap_t * test_leftist_heap_sample(uint64 range, uint32 size);
static inline s_maximal_heap_t * test_maximal_heap_sample(uint64 range, uint32 size);
static inline s_min_max_heap_t * test_min_max_heap_sample(uint64 range, uint32 size);
static inline s_minimal_heap_t * test_minimal_heap_sample(uint64 range, uint32 size);
static inline s_open_addressing_hash_t * test_open_addressing_hash_sample(uint32 count);
static inline s_separate_chain_hash_t * test_separate_chain_hash_sample(uint32 count);
...
static inline s_splay_tree_t * test_splay_tree_sample(uint64 range, uint32 node_count);
...
static inline uint32 utest_directed_graph_minimal_path(s_graph_paths_t *paths);
static inline void * utest_mutex_thread_0(void *mutex_sample);
static inline void * utest_mutex_thread_1(void *mutex_sample);
static inline void * utest_mutex_thread_try(void *mutex_sample);
...
static inline void * utest_semaphore_thread_try(void *semaphore_sample);
static inline void * utest_spin_lock_thread(void *lock_sample);
static inline void * utest_spin_lock_try_thread(void *lock_sample);
...
static inline void ptest_mutex_create(uint32 count);
static inline void ptest_mutex_destroy(uint32 count);
static inline void ptest_mutex_lock(uint32 count);
static inline void ptest_mutex_lock_try(uint32 count);
static inline void ptest_mutex_locked_p(uint32 count);
static inline void ptest_mutex_unlock(uint32 count);
static inline void ptest_mutex_unlocked_p(uint32 count);
...
static inline void ptest_semaphore_down_try(uint32 count);
static inline void ptest_semaphore_unavailable_p(uint32 count);
static inline void ptest_semaphore_up(uint32 count);
static inline void ptest_spin_lock(uint32 count);
...
static inline void ptest_spin_locked_p(uint32 count);
static inline void ptest_spin_unlock(uint32 count);
static inline void ptest_spin_unlocked_p(uint32 count);
...
static inline void utest_indirected_graph_util(void);
...
static inline void utest_mutex_create(void);
static inline void utest_mutex_destroy(void);
static inline void utest_mutex_lock(void);
static inline void utest_mutex_lock_try(void);
static inline void utest_mutex_locked_p(void);
static inline void utest_mutex_unlock(void);
static inline void utest_mutex_unlocked_p(void);
...
static inline void utest_semaphore_down_try(void);
static inline void utest_semaphore_unavailable_p(void);
static inline void utest_semaphore_up(void);
static inline void utest_spin_lock(void);
...
static inline void utest_spin_locked_p(void);
static inline void utest_spin_unlock(void);
static inline void utest_spin_unlocked_p(void);
