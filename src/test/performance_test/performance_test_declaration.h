...
static void performance_test_single_linked_list_node_insert_after_risky(uint32 count);
static void performance_test_single_linked_list_node_insert_before(uint32 count);
static void performance_test_single_linked_list_node_insert_before_risky(uint32 count);
