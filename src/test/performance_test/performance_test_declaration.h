...
static void performance_test_doubly_end_queue_front_enter(uint32 count);
static void performance_test_doubly_end_queue_front_leave(uint32 count);
...
static void performance_test_doubly_end_queue_rear_enter(uint32 count);
static void performance_test_doubly_end_queue_rear_leave(uint32 count);
