...
PT_LINKED_LIST_node_create(single)
PT_LINKED_LIST_previous(single)
PT_LINKED_LIST_insert_ptr_after(single)
PT_LINKED_LIST_insert_ptr_before(single)
...
PT_LINKED_LIST_remove_and_destroy(single)
