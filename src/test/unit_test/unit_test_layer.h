...
static const struct test_layer_table single_linked_list_interface[] = {
    ...
    {"node_remove_and_destroy", {&unit_test_single_linked_list_node_remove_and_destroy,},},
...
static const struct test_layer_table doubly_linked_list_interface[] = {
    ...
    {"node_remove_and_destroy", {&unit_test_doubly_linked_list_node_remove_and_destroy,},},
...
static const struct test_layer_table binary_search_tree[] = {
    ...
    {"node_contains_p",         {&unit_test_binary_search_tree_node_contains_p,},},
    {"node_insert",             {&unit_test_binary_search_tree_node_insert,},},
    {"node_remove",             {&unit_test_binary_search_tree_node_remove,},},
    {"node_remove_and_destroy", {&unit_test_binary_search_tree_node_remove_and_destroy,},},
...
static const struct test_layer_table avl_tree[] = {
    ...
    {"node_contains_p",         {&unit_test_avl_tree_node_contains_p,},},
    ...
    {"node_remove_and_destroy", {&unit_test_avl_tree_node_remove_and_destroy,},},
...
static const struct test_layer_table splay_tree[] = {
    ...
    {"node_contains_p",         {&unit_test_splay_tree_node_contains_p,},},
    {"node_insert",             {&unit_test_splay_tree_node_insert,},},
    {"node_remove",             {&unit_test_splay_tree_node_remove,},},
    {"node_remove_and_destroy", {&unit_test_splay_tree_node_remove_and_destroy,},},
...
static const struct test_layer_table minimal_heap[] = {
    ...
    {"node_remove_min_and_destroy", {&unit_test_minimal_heap_node_remove_min_and_destroy,},},
    {"node_remove",                 {&unit_test_minimal_heap_node_remove,},},
    {"node_remove_and_destroy",     {&unit_test_minimal_heap_node_remove_and_destroy,},},
...
static const struct test_layer_table maximal_heap[] = {
    {"struct_field",                {&unit_test_maximal_heap_struc_field,},},
    {"create",                      {&unit_test_maximal_heap_create,},},
    {"destroy",                     {&unit_test_maximal_heap_destroy,},},
    {"empty_p",                     {&unit_test_maximal_heap_empty_p,},},
    {"full_p",                      {&unit_test_maximal_heap_full_p,},},
    {"cleanup",                     {&unit_test_maximal_heap_cleanup,},},
    {"node_find",                   {&unit_test_maximal_heap_node_find,},},
    {"node_find_max",               {&unit_test_maximal_heap_node_find_max,},},
    {"node_insert",                 {&unit_test_maximal_heap_node_insert,},},
    {"node_remove_max",             {&unit_test_maximal_heap_node_remove_max,},},
