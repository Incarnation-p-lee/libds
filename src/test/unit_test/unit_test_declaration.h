...
static void unit_test_doubly_linked_list_insert_after(void);
static void unit_test_doubly_linked_list_insert_before(void);
...
static void unit_test_doubly_linked_list_remove(void);
static void unit_test_doubly_linked_list_remove_and_destroy(void);
...
static void unit_test_single_linked_list_insert_after(void);
static void unit_test_single_linked_list_insert_before(void);
...
static void unit_test_single_linked_list_previous(void);
