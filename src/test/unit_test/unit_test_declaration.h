...
static inline struct utest_sort_data * utest_sort_data_array(uint32 size);
static inline struct utest_sort_data ** utest_sort_data_ptr_array(uint32 size);
...
static inline void utest_sort_data_ptr_array_destroy(struct utest_sort_data **data, uint32 size);
