...
unit_test_doubly_end_queue_destroy(void)
{
    ...
    UNIT_TEST_RESULT(doubly_end_queue_destroy, pass);
}
...
unit_test_doubly_end_queue_head_enter(void)
{
    ...
    doubly_end_queue_destroy(&queue);
    UNIT_TEST_RESULT(doubly_end_queue_head_enter, pass);
}
...
unit_test_doubly_end_queue_tail_enter(void)
{
    ...
    doubly_end_queue_destroy(&queue);
    UNIT_TEST_RESULT(doubly_end_queue_tail_enter, pass);
}
...
unit_test_doubly_end_queue_head_leave(void)
{
    ...
    doubly_end_queue_destroy(&queue);
    UNIT_TEST_RESULT(doubly_end_queue_head_leave, pass);
}
...
unit_test_doubly_end_queue_tail_leave(void)
{
    ...
    doubly_end_queue_destroy(&queue);
    UNIT_TEST_RESULT(doubly_end_queue_tail_leave, pass);
}
