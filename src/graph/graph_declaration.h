...
static inline s_adjacent_t * directed_graph_vertex_precursor(s_vertex_t *vertex);
static inline s_adjacent_t * directed_graph_vertex_successor(s_vertex_t *vertex);
...
static inline void indirected_graph_vertex_edge_remove(s_vertex_t *vertex, s_edge_t *edge);
static uint32 graph_attribute_edge_count(s_graph_t *graph);
static uint32 graph_attribute_vertex_count(s_graph_t *graph);
