...
s_array_queue_t * directed_graph_path_find(s_vertex_t *vertex_from, s_vertex_t *vertex_to);
...
s_vertex_t * directed_vertex_array_vertex(s_vertex_array_t *vertex_array, uint32 i);
...
static inline bool graph_dijkstra_entry_is_unknown_p(s_dijkstra_entry_t *dj_entry);
...
static inline s_array_queue_t * directed_graph_path_find_i(s_vertex_t *vertex_from, s_vertex_t *vertex_to);
...
static inline s_vertex_t * directed_graph_path_unvisited_succ_vertex_find(s_vertex_t *vertex, s_open_addressing_hash_t *hash);
...
static inline void directed_graph_path_stack_to_queue(s_array_queue_t *queue, s_array_stack_t *stack);
